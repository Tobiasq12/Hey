...
function Menu:addPurchase(name,price,info,args)
	...
	if currentpos and currentpos.free then
		button.price = 0
	else
						...
						if menu.selected == i then
							...
							if btn.sprite ~= nil then
								if btn.sprite == "garage" then
									...
									DrawSprite("commonmenu", btn.sprite .. "b", x + (width/2.4), y, scale/10 -0.01, scale/10 +0.01, 0.00,cfg.text_color.r,cfg.text_color.g,cfg.text_color.b,cfg.text_color.a)
								end
							...
							if btn.sprite ~= nil then
								if btn.sprite == "garage" then
									...
									DrawSprite("commonmenu", btn.sprite, x + (width/2.4), y, scale/10 -0.01, scale/10 +0.01, 0.00,cfg.text_color.r,cfg.text_color.g,cfg.text_color.b,cfg.text_color.a)
								end
							elseif btn.price ~= nil then
								if btn.price ~= 0 then
									if not btn.purchased then
