...
------Neon layout------
	...
	-- Headlight color
	headlightcolor = {
		{name = "Default", mod = -1, price = 12000},
	    {name = "White", mod = 0, price = 12000},
	    {name = "Blue", mod = 1, price = 12000},
	    {name = "Electric Blue", mod = 2, price = 12000},
	    {name = "Mint Green", mod = 3, price = 12000},
	    {name = "Lime Green", mod = 4, price = 12000},
	    {name = "Yellow", mod = 5, price = 12000},
	    {name = "Golden Shower", mod = 6, price = 12000},
	    {name = "Orange", mod = 7, price = 12000},
	    {name = "Red", mod = 8, price = 12000},
	    {name = "Pony Pink", mod = 9, price = 12000},
	    {name = "Hot Pink", mod = 10, price = 12000},
	    {name = "Purple", mod = 11, price = 12000},
	    {name = "Blacklight", mod = 12, price = 12000},
	},
...
----Sport wheels-----
	sportwheels = {
		...
		{name = {"en01"}, wtype = 0, mod = 50, price = 1000},
		{name = {"mgp"}, wtype = 0, mod = 51, price = 1000},
		{name = {"re30"}, wtype = 0, mod = 52, price = 1000},
		{name = {"agt1"}, wtype = 0, mod = 53, price = 1000},
		{name = {"agt2"}, wtype = 0, mod = 54, price = 1000},
		{name = {"cr01"}, wtype = 0, mod = 55, price = 1000},
		{name = {"rpf1"}, wtype = 0, mod = 56, price = 1000},
		{name = {"rp03"}, wtype = 0, mod = 57, price = 1000},
		{name = {"te37"}, wtype = 0, mod = 58, price = 1000},
		{name = {"te37v"}, wtype = 0, mod = 59, price = 1000},
		{name = {"sa60"}, wtype = 0, mod = 60, price = 1000},
		{name = {"bt3"}, wtype = 0, mod = 61, price = 1000},
		{name = {"rg2"}, wtype = 0, mod = 62, price = 1000},
		{name = {"p45r"}, wtype = 0, mod = 63, price = 1000},
		{name = {"mf10"}, wtype = 0, mod = 64, price = 1000},
		{name = {"sw388"}, wtype = 0, mod = 65, price = 1000},
		{name = {"5gn"}, wtype = 0, mod = 66, price = 1000},
		{name = {"57c6"}, wtype = 0, mod = 67, price = 1000},
		{name = {"rs050rr"}, wtype = 0, mod = 68, price = 1000},
		{name = {"ms1"}, wtype = 0, mod = 69, price = 1000},
		{name = {"wrs"}, wtype = 0, mod = 70, price = 1000},
		{name = {"ms01"}, wtype = 0, mod = 71, price = 1000},
		{name = {"ce28"}, wtype = 0, mod = 72, price = 1000},
		{name = {"e40"}, wtype = 0, mod = 73, price = 1000},
		{name = {"ml1"}, wtype = 0, mod = 74, price = 1000},
		{name = {"mk2r"}, wtype = 0, mod = 75, price = 1000},
		{name = {"blm"}, wtype = 0, mod = 76, price = 1000},
		{name = {"lg4"}, wtype = 0, mod = 77, price = 1000},
		{name = {"lg1"}, wtype = 0, mod = 78, price = 1000},
		{name = {"gtc"}, wtype = 0, mod = 79, price = 1000},
		{name = {"dh"}, wtype = 0, mod = 80, price = 1000},
		{name = {"jps"}, wtype = 0, mod = 81, price = 1000},
		{name = {"svk"}, wtype = 0, mod = 82, price = 1000},
		{name = {"sv"}, wtype = 0, mod = 83, price = 1000},
		{name = {"037"}, wtype = 0, mod = 84, price = 1000},
		{name = {"rnr"}, wtype = 0, mod = 85, price = 1000},
		{name = {"vskf"}, wtype = 0, mod = 86, price = 1000},
		{name = {"vsxx"}, wtype = 0, mod = 87, price = 1000},
		{name = {"cst"}, wtype = 0, mod = 88, price = 1000},
		{name = {"fe"}, wtype = 0, mod = 89, price = 1000},
		{name = {"sfm"}, wtype = 0, mod = 90, price = 1000},
		{name = {"sfm2"}, wtype = 0, mod = 91, price = 1000},
		{name = {"sss"}, wtype = 0, mod = 92, price = 1000},
		{name = {"sps3"}, wtype = 0, mod = 93, price = 1000},
		{name = {"eav"}, wtype = 0, mod = 94, price = 1000},
		{name = {"bp1"}, wtype = 0, mod = 95, price = 1000},
		{name = {"tsl"}, wtype = 0, mod = 96, price = 1000},
		{name = {"mle"}, wtype = 0, mod = 97, price = 1000},
		{name = {"ozr"}, wtype = 0, mod = 98, price = 1000},
		{name = {"we1"}, wtype = 0, mod = 99, price = 1000},
		{name = {"dyc"}, wtype = 0, mod = 100, price = 1000},
		{name = {"fm1"}, wtype = 0, mod = 101, price = 1000},
		{name = {"scc"}, wtype = 0, mod = 102, price = 1000},
		{name = {"bp8"}, wtype = 0, mod = 103, price = 1000},
		{name = {"wkb"}, wtype = 0, mod = 104, price = 1000},
		{name = {"ete1"}, wtype = 0, mod = 105, price = 1000},
		{name = {"brs"}, wtype = 0, mod = 106, price = 1000},
		{name = {"gx1"}, wtype = 0, mod = 107, price = 1000},
		{name = {"est"}, wtype = 0, mod = 108, price = 1000},
		{name = {"rct4"}, wtype = 0, mod = 109, price = 1000},
		{name = {"cr9"}, wtype = 0, mod = 110, price = 1000},
		{name = {"gtc1"}, wtype = 0, mod = 111, price = 1000},
		{name = {"h06"}, wtype = 0, mod = 112, price = 1000},
	},
-----Suv wheels------
	suvwheels = {
